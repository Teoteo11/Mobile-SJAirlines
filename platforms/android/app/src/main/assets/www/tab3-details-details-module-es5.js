...
var DetailsPage = /** @class */ (function () {
    function DetailsPage(airplaneService, activatedRoute, socket, toastCtrl) {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4 /*yield*/, this.airplaneService.getAirplaneById(this.idAirplane)];
                    case 1:
                        _a.airplane = _b.sent();
                        this.socket.connect();
                        this.socket.emit("set-airplane", this.airplane);
                        this.socket.fromEvent("airplane-changed").subscribe(function (data) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                            var _a;
                            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        _a = this;
                                        return [4 /*yield*/, this.airplaneService.getAirplaneById(this.airplane._id)];
                                    case 1:
                                        _a.airplane = _b.sent();
    ...
    DetailsPage.prototype.showToast = function (msg) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var toast;
...
var AirplaneService = /** @class */ (function () {
    function AirplaneService(httpClient) {
        this.httpClient = httpClient;
        this.apiURL = "http://localhost:3004/airplanes";
    }
    AirplaneService.prototype.getAirplaneById = function (id) {
        return this.httpClient
            .get(this.apiURL + "/?id=" + id)
            .toPromise();
    };
    AirplaneService.ctorParameters = function () { return [
...
//# sourceMappingURL=tab3-details-details-module-es5.js.map